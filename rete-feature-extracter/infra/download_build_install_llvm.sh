...
LLVM_URL="http://releases.llvm.org/3.8.1/llvm-3.8.1.src.tar.xz"
LLVM_ARCHIVE="llvm-3.8.1.src.tar.xz"
CLANG_URL="http://releases.llvm.org/3.8.1/cfe-3.8.1.src.tar.xz"
CLANG_ARCHIVE="cfe-3.8.1.src.tar.xz"
COMPILER_RT_URL="http://releases.llvm.org/3.8.1/compiler-rt-3.8.1.src.tar.xz"
COMPILER_RT_ARCHIVE="compiler-rt-3.8.1.src.tar.xz"
CLANG_TOOLS_EXTRA_URL="http://releases.llvm.org/3.8.1/clang-tools-extra-3.8.1.src.tar.xz"
CLANG_TOOLS_EXTRA_ARCHIVE="clang-tools-extra-3.8.1.src.tar.xz"
LIBCXX_URL="https://releases.llvm.org/3.8.1/libcxx-3.8.1.src.tar.xz"
LIBCXX_ARCHIVE="libcxx-3.8.1.src.tar.xz"
...
mkdir -p "src/libcxx"
tar xf "$LIBCXX_ARCHIVE" --directory "src/libcxx" --strip-components=1
ls src/
