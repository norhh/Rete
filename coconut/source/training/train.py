...
def train_fconv(dropout,
    ...
    cmd = 'python3 ' + fairseqdir + 'train.py --save-dir ' + savedir + \
...
def train_context(dropout,
    ...
    cmd = 'python3 ' + fairseqdir + 'train.py --use-context --skip-invalid-size-inputs-valid-test --save-dir ' + savedir + \
...
def train_trans(dropout,
    ...
    cmd = 'python3 ' + fairseqdir + 'train.py --skip-invalid-size-inputs-valid-test --save-dir ' + savedir + \
